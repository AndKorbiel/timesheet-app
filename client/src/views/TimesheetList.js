                  ...
                  <TableHead>
                    <TableRow>
                      {columns.map((el, index) => {
                        return <TableCell key={index + 1}>{el}</TableCell>;
                      })}
                          ...
                          return (
                            <>
                              ...
                              {project.timesheets.length > 0 && (
                                <TableRow className="inner-header">
                                  ...
                                  <TableCell>
                                    {
                                      props.translations
                                        .timesheets_list_table_date
                                    }
                                  </TableCell>
                                  <TableCell>
                                    {
                                      props.translations
                                        .timesheets_list_table_edit
                                    }
                                  </TableCell>
                                </TableRow>
                              )}
                                ...
                                project.timesheets.map((timesheet, j) => {
                                  return (
                                    <TableRow key={j + 1}>
                                      ...
                                      <TableCell>{timesheet.minutes}</TableCell>
                                      <TableCell>{timesheet.pages}</TableCell>
                                      <TableCell>
                              ...
                              <TableRow className="subtotal">
                                ...
                                <TableCell colSpan={3}>
                                  {calculateTotal(project.timesheets, 'pages')}{' '}
                                  {
                                    props.translations
                                      .timesheets_list_table_pages
                                  }
                              ...
                              <CustomDialog
                                ...
                                title={
                                  props.translations.timesheets_dialog_title
                                }
                                description={
                                  props.translations.timesheets_dialog_subtitle
                                }
